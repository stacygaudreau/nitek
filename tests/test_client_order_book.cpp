...
//}
//
//TEST_F(ClientOrderBookBasics, adds_order_to_book) {
...
//}
//
//TEST_F(ClientOrderBookBasics, adding_passive_order) {
...
//}
//
//TEST_F(ClientOrderBookBasics, cancels_passive_order) {
...
//class ClientOrderBookMatching : public ::testing::Test {
//protected:
...
//
//
//TEST_F(ClientOrderBookMatching, executes_partial_match) {
...
//}
//
//TEST_F(ClientOrderBookMatching, executes_full_match) {
//    // the match() method executes a given order against
...
//}
//
//TEST_F(ClientOrderBookMatching, finds_match_for_bid) {
...
//}
//
//TEST_F(ClientOrderBookMatching, finds_match_for_ask) {
...
//}
//
//TEST_F(ClientOrderBookMatching, incoming_bid_order_matches_passive_ask) {
...
//}
//
//TEST_F(ClientOrderBookMatching, incoming_ask_order_matches_passive_bids) {
